<?php return array (
  ...
  'admin.error.executingUtil' => 'Lỗi: không thể thực thi "{$usingPath}". Kiểm tra cài đặt {$usingVar} của bạn trong config.inc.php.',
  'admin.error.utilExecutionProblem' => 'Việc thực thi chương trình "{$usingPath}" trả lại lỗi sau: {$output}',
  'admin.copyAccessLogFileTool.success' => 'Thành công: {$filePath} đến {$destinationPath}',
  'admin.copyAccessLogFileTool.warning.fileAlreadyExists' => 'Cảnh báo: tệp {$filePath} đã tồn tại bên trong thư mục thống kê sử dụng.',
  'admin.copyAccessLogFileTool.error.deletingFile' => 'Lỗi: không thể xóa tệp {$tmpFilePath}',
  'admin.copyAccessLogFileTool.error.copyingFile' => 'Lỗi: không thể sao chép tệp từ {$filePath} sang {$tmpFilePath}',
  'admin.copyAccessLogFileTool.error.acessingFile' => 'Lỗi: Tệp {$filePath} không tồn tại hoặc không thể truy cập được.',
  'admin.copyAccessLogFileTool.error.creatingFolder' => 'Lỗi: không thể tạo thư mục tạm thời {$tmpDir}',
  'admin.copyAccessLogFileTool.usage' => 'Sao chép (các) tệp nhật ký truy cập apache đã thông qua, lọc các mục nhập liên quan đến cài đặt này,
...
kết quả tìm kiếm. Vui lòng chọn một trong các chỉ số đã định cấu hình làm mặc định.
  ...
  'admin.languages.download.cannotModifyRegistry' => 'Không thể thêm ngôn ngữ mới vào tệp đăng ký ngôn ngữ, thường là "registry/locales.xml".',
  'admin.languages.download.cannotOpen' => 'Không thể mở bộ mô tả ngôn ngữ từ trang web PKP.',
  'admin.languages.downloadLocales' => 'Tải xuống Các ngôn ngữ',
  'admin.languages.download' => 'Tải xuống Ngôn ngữ',
  ...
  'admin.authSources' => 'Các nguồn xác thực',
  'admin.auth.noneCreated' => 'Không có nguồn xác thực nào được xác định.',
  'admin.auth.create' => 'Tạo nguồn xác thực',
  'admin.auth.confirmDelete' => 'Bạn có chắc chắn muốn xóa vĩnh viễn nguồn xác thực này không?',
