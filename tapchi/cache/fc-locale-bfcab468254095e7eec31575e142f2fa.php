<?php return array (
  'api.vocabs.400.vocabNotSupported' => 'Thông số {$vocab}  không được hỗ trợ.',
  ...
  'api.temporaryFiles.400.config' => 'Không thể tải tệp lên do lỗi cấu hình máy chủ. Hãy liên hệ với quản trị hệ thống.',
  'api.temporaryFiles.400.fileSize' => 'Các tệp lớn hơn $maxSize} không thể được tải lên.',
  'api.temporaryFiles.409.uploadFailed' => 'Không thể tải lên một hoặc nhiều tệp.',
  'api.temporaryFiles.400.noUpload' => 'Không tìm thấy tệp được tải lên với yêu cầu.',
  'api.submissions.unknownError' => 'Một lỗi không mong muốn đã xảy ra. Hãy tải lại trang và thử lại.',
