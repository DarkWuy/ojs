<?php
/* Smarty version 4.1.0, created on 2023-06-24 07:55:27
  from 'core:reviewerreviewstep1.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_6496854f02d391_87413243',
...
function content_6496854f02d391_87413243 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\tapchi\\lib\\pkp\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
echo '<script'; ?>
 type="text/javascript">
	$(function() {
		...
		$('#noCompetingInterests').click(function() {
			$('#reviewerCompetingInterestsContainer').hide(100);
		});
		$('#hasCompetingInterests').click(function() {
			$('#reviewerCompetingInterestsContainer').show(100);
		});
		if (<?php if ($_smarty_tpl->tpl_vars['reviewerCompetingInterests']->value) {?>0<?php } else { ?>1<?php }?>) {
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('id'=>"reviewerCompetingInterestsContainer"));
$_block_repeat=true;
echo $_block_plugin9->smartyFBVFormSection(array('id'=>"reviewerCompetingInterestsContainer"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		...
		<?php $_block_repeat=false;
echo $_block_plugin9->smartyFBVFormSection(array('id'=>"reviewerCompetingInterestsContainer"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php }?>
