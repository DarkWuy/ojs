<?php
/* Smarty version 4.1.0, created on 2023-06-22 03:58:29
  from 'app:frontendobjectsgalleylink' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_6493aac516b870_04845903',
...
function content_6493aac516b870_04845903 (Smarty_Internal_Template $_smarty_tpl) {
...
<a class="<?php if ($_smarty_tpl->tpl_vars['isSupplementary']->value) {?>obj_galley_link_supplementary btn btn-light text-primary<?php } else { ?>obj_galley_link btn btn-primary <?php }?> <?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['type']->value ));
if ($_smarty_tpl->tpl_vars['restricted']->value) {?> restricted btn btn-danger<?php }?>" href="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('page'=>$_smarty_tpl->tpl_vars['page']->value,'op'=>"view",'path'=>$_smarty_tpl->tpl_vars['path']->value),$_smarty_tpl ) );?>
