...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_6449fbba452687_56507373',
...
function content_6449fbba452687_56507373 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
			...
			<form class="_cmp_form register needs-validation" id="register" method="post" action="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('op'=>"register"),$_smarty_tpl ) );?>
">
						...
						<?php if ($_smarty_tpl->tpl_vars['currentContext']->value->getData('privacyStatement')) {?>
							...
							<div class="fields">
								<div class="optin optin-privacy form-group mb-4">
									<input type="checkbox" name="privacyConsent" value="1"<?php if ($_smarty_tpl->tpl_vars['privacyConsent']->value) {?> checked="checked"<?php }?> class="form-check-input" id="privacy_consent">
...
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
						...
						<?php }?>
							...
							<div class="optin optin-email form-group mb-4">
								<input type="checkbox" name="emailConsent" value="1"<?php if ($_smarty_tpl->tpl_vars['emailConsent']->value) {?> checked="checked"<?php }?> class="form-check-input" id="email_consent" />
...
]" value="1"<?php if (in_array($_smarty_tpl->tpl_vars['userGroupId']->value,$_smarty_tpl->tpl_vars['userGroupIds']->value)) {?> checked="checked"<?php }?> class="form-check-input" id="reviewerGroup[<?php echo $_smarty_tpl->tpl_vars['userGroupId']->value;?>
]">
...
" class="login btn btn-lg btn-light text-dark col-12 mb-4"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"user.login"),$_smarty_tpl ) );?>
</a>
				</div>
			</form>
