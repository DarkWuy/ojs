<?php
/* Smarty version 4.1.0, created on 2023-06-12 05:48:21
  from 'app:controllersgridsubmission' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_64869585045d21_65517172',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0e63e9a7ef714b99a981fb27cd47a9d5897b2827' => 
    array (
      0 => 'app:controllersgridsubmission',
      1 => 1675470231,
      2 => 'app',
    ),
  ),
...
function content_64869585045d21_65517172 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_assignInScope('formId', call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( "submissionsListFilter-",$_smarty_tpl->tpl_vars['filterData']->value['gridId'] )));
echo '<script'; ?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormArea', array('id'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( "submissionSearchFormArea",$_smarty_tpl->tpl_vars['filterData']->value['gridId'] ))));
$_block_repeat=true;
echo $_block_plugin1->smartyFBVFormArea(array('id'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( "submissionSearchFormArea",$_smarty_tpl->tpl_vars['filterData']->value['gridId'] ))), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
while ($_block_repeat) {
ob_start();?>
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"select",'name'=>"issueId",'id'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( "issueId",$_smarty_tpl->tpl_vars['filterData']->value['gridId'] )),'from'=>$_smarty_tpl->tpl_vars['filterData']->value['issues'],'selected'=>$_smarty_tpl->tpl_vars['filterSelectionData']->value['issueId'],'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['SMALL'],'translate'=>false,'inline'=>"true"),$_smarty_tpl ) );?>

			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"select",'name'=>"statusId",'id'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( "statusId",$_smarty_tpl->tpl_vars['filterData']->value['gridId'] )),'from'=>$_smarty_tpl->tpl_vars['filterData']->value['status'],'selected'=>$_smarty_tpl->tpl_vars['filterSelectionData']->value['statusId'],'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['SMALL'],'translate'=>false,'inline'=>"true"),$_smarty_tpl ) );?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	...
	<?php $_block_repeat=false;
echo $_block_plugin1->smartyFBVFormArea(array('id'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'concat' ][ 0 ], array( "submissionSearchFormArea",$_smarty_tpl->tpl_vars['filterData']->value['gridId'] ))), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
</form>
<?php }
