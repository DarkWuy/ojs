...
function content_64869541229726_48855590 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
ob_start();?>
			...
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"text",'id'=>"username",'value'=>$_smarty_tpl->tpl_vars['username']->value,'label'=>"plugins.importexport.crossref.settings.form.username",'maxlength'=>"50",'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM']),$_smarty_tpl ) );?>
