<?php
/* Smarty version 4.1.0, created on 2023-06-24 01:05:44
  from 'app:layoutsbackend.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_64962548aa0131_93112526',
...
function content_64962548aa0131_93112526 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\tapchi\\lib\\pkp\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.replace.php','function'=>'smarty_modifier_replace',),));
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['currentContext']->value) {?>
				<div class="square-box">
					<a href="#menu" class="menu-icon"><i class="fa-solid fa-bars" style="color:#ffffff;"></i></a>
				</div>
...
">
		...
		<div class="app__body">
			<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_165752838764962548a93cf3_66566026', "menu");
?>
			...
			<main class="app__main">
				<div class="app__page<?php if ($_smarty_tpl->tpl_vars['pageWidth']->value) {?> app__page--<?php echo $_smarty_tpl->tpl_vars['pageWidth']->value;
					...
					<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_36276540164962548a95680_81939648', "breadcrumbs");
?>


					<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_32819441064962548a998a0_55528140', "page");
?>
...
var appNav = document.querySelector('.app__nav');
var appMain = document.querySelector('.app__main');

menuIcon.addEventListener('click', function() {
appNav.classList.toggle('active'); /* Thêm hoặc xóa class 'active' */
appMain.classList.toggle('active'); /* Thêm hoặc xóa class 'active' */
});
...
<?php }
/* {block "menu"} */
class Block_165752838764962548a93cf3_66566026 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'menu' => 
  array (
    0 => 'Block_165752838764962548a93cf3_66566026',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>

				<nav v-if="!!menu && Object.keys(menu).length > 1" class="app__nav menu" id="menu" aria-label="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"common.navigation.site"),$_smarty_tpl ) );?>
">
					<ul>
						<li v-for="(menuItem, key) in menu" :key="key" :class="!!menuItem.submenu ? 'app__navGroup' : ''">
							...
							<div v-if="!!menuItem.submenu" class="app__navItem app__navItem--hasSubmenu">
								<i class="icon fa fa-home fa-fw " aria-hidden="true" aria-label=""></i>{{ menuItem.name }}
							</div>
...
/* {/block "menu"} */
/* {block "breadcrumbs"} */
class Block_36276540164962548a95680_81939648 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'breadcrumbs' => 
  array (
    0 => 'Block_36276540164962548a95680_81939648',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
/* {/block "breadcrumbs"} */
/* {block "page"} */
class Block_32819441064962548a998a0_55528140 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page' => 
  array (
    0 => 'Block_32819441064962548a998a0_55528140',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
}
