...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_671511c62d79e1_34012403',
...
function content_671511c62d79e1_34012403 (Smarty_Internal_Template $_smarty_tpl) {
...
"
 ...
 class="title text-start text-md-start" style="font-size: 1.15rem;">
...
?>
					<!-- Nút tóm tắt -->
					<button class="btn btn-info" onclick="toggleAbstract('<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['article']->value->getLocalizedAbstract() ));?>
', 'abstract-<?php echo $_smarty_tpl->tpl_vars['article']->value->getId();?>
')" style="font-size: 0.9em;"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"article.summary"),$_smarty_tpl ) );?>
</button>
					<!-- Phần để hiển thị tóm tắt -->
					<div id="abstract-<?php echo $_smarty_tpl->tpl_vars['article']->value->getId();?>
" class="abstract-display larger-abstract" style="display:none; border: 1px solid #ccc; padding: 10px; margin-top: 10px; font-family: 'Georgia', serif; line-height: 1.6; font-size: 1.1em;"></div>
				</li>
			<?php
}
