<?php
/* Smarty version 4.1.0, created on 2023-05-12 15:56:35
  from 'app:paymentsinstitutionalSubs' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_645e45933255b0_52483469',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '06085200cdeca87998d14567a4aecd563af7a90c' => 
    array (
      0 => 'app:paymentsinstitutionalSubs',
      1 => 1675470231,
      2 => 'app',
    ),
  ),
...
function content_645e45933255b0_52483469 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
>
	$(function() {
...
<?php echo '</script'; ?>
>
<form class="pkp_form" method="post" id="institutionalSubscriptionForm" action="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('op'=>"updateSubscription"),$_smarty_tpl ) );?>
">
...
" />
	...
	<?php $_smarty_tpl->_subTemplateRender("app:controllers/notification/inPlaceNotification.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('notificationId'=>"institutionalSubscriptionNotification"), 0, false);
?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormArea', array('id'=>"institutionalSubscriptionFormArea"));
$_block_repeat=true;
echo $_block_plugin1->smartyFBVFormArea(array('id'=>"institutionalSubscriptionFormArea"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"text",'label'=>"manager.subscriptions.form.institutionName",'required'=>true,'name'=>"institutionName",'id'=>"institutionName",'value'=>$_smarty_tpl->tpl_vars['institutionName']->value,'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM']),$_smarty_tpl ) );?>

		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"textarea",'label'=>"manager.subscriptions.form.institutionMailingAddress",'name'=>"institutionMailingAddress",'id'=>"institutionMailingAddress",'value'=>$_smarty_tpl->tpl_vars['institutionMailingAddress']->value),$_smarty_tpl ) );?>


		<span class="instructions"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"manager.subscriptions.form.domainInstructions"),$_smarty_tpl ) );?>
</span>
		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"text",'label'=>"manager.subscriptions.form.domain",'name'=>"domain",'id'=>"domain",'value'=>$_smarty_tpl->tpl_vars['domain']->value,'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM']),$_smarty_tpl ) );?>


		<span class="instructions"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"manager.subscriptions.form.ipRangeInstructions"),$_smarty_tpl ) );?>
</span>
		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"textarea",'label'=>"manager.subscriptions.form.ipRange",'name'=>"ipRanges",'id'=>"ipRanges",'value'=>$_smarty_tpl->tpl_vars['ipRanges']->value,'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM']),$_smarty_tpl ) );?>


		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"text",'label'=>"manager.subscriptions.form.referenceNumber",'name'=>"referenceNumber",'id'=>"referenceNumber",'value'=>$_smarty_tpl->tpl_vars['referenceNumber']->value,'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['MEDIUM']),$_smarty_tpl ) );?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	<?php $_block_repeat=false;
echo $_block_plugin1->smartyFBVFormArea(array('id'=>"institutionalSubscriptionFormArea"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
	...
	<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvFormButtons'][0], array( array('id'=>"institutionalSubscriptionFormSubmit",'submitText'=>"common.save",'hideCancel'=>true),$_smarty_tpl ) );?>
