<?php return array (
  'submission.submit.title' => 'Gửi một bài báo mới',
  'submission.submit.userGroup' => 'Gửi trong vai trò như là ...',
  'submission.submit.userGroupDescription' => 'Chọn tư cách mà bạn đang gửi bài báo này.',
  ...
  'submission.confirmSubmit' => 'Bạn có chắc chắn muốn gửi bài báo này đến tạp chí?',
  'workflow.review.externalReview' => 'Phản biện',
  'editor.submission.decision.sendExternalReview' => 'Gửi phản biện',
  ...
  'submission.submit.form.localeRequired' => 'Vui lòng chọn một ngôn ngữ của bài gửi.',
  ...
  'publication.assignedToIssue' => 'Điều này đã được gán cho <a href="{$issueUrl}">{$issueName}</a> nhưng nó Chưa được lên kế hoạch công bố.',
  ...
  'submission.submit.form.authorRequiredFields' => 'Họ, tên và địa chỉ email của mỗi tác giả là bắt buộc.',
  ...
  'publication.issue.success' => 'Chi tiết của số phát hành của ấn phẩm đã được cập nhật.',
);