<?php return array (
  ...
  'submission.event.author.authorRevision' => 'Bản sửa chữa của tác giả đã được gửi',
  'submission.event.general.authorRevision' => 'Tập tin sửa chữa của tác giả đã được cập nhật',
  ...
  'submission.event.editor.editorFile' => 'Cập nhật Tập tin của Biên tập viên',
  ...
  'submission.event.copyedit.copyeditorAssigned' => 'Biên tập viên bản thảo đã được phân công cho  bài gửi',
  'submission.event.copyedit.copyeditorUnassigned' => 'Biên tập viên bản thảo đã không được phân công cho bài gửi',
  ...
  'submission.event.copyedit.copyeditFinalCompleted' => 'Biên tập Bản thảo cuối đã hoàn thành',
  'submission.event.copyedit.copyeditSetFile' => 'Đã cập nhật Tập tin bản thảo biên tập',
  ...
  'submission.event.proofread.proofreadRevision' => 'Đã cập nhật Tệp sửa đổi Hiệu đính',
  ...
  'admin.auth.defaultSourceDescription' => '<p>Chỉ định nguồn xác thực mặc định khác với OJS có các hiệu ứng sau:</p>
<ul>
	<li>Nếu người dùng cố gắng đăng ký tài khoản mới với trang web này với tên người dùng tồn tại trên nguồn xác thực (nhưng không phải trong cơ sở dữ liệu OJS), nỗ lực đăng ký chỉ được phép nếu mật khẩu được cung cấp hợp lệ cho tài khoản người dùng đó.</li>
</ul>',
...
Máy chủ của bạn hiện đang hỗ trợ mbstring: <strong>{$supportsMBString}</strong>',
  ...
  'installer.additionalLocalesInstructions' => 'Chọn bất kỳ ngôn ngữ bổ sung để hỗ trợ trong hệ thống này. Các ngôn ngữ này sẽ có sẵn để sử dụng bởi các tạp chí được lưu trữ trên trang web. Các ngôn ngữ bổ sung cũng có thể được cài đặt bất cứ lúc nào từ giao diện quản trị trang web.',
