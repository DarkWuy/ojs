<?php return array (
  ...
  'author.submit.nextSteps' => 'Chờ kiểm duyệt',
  'submission.submit.cancelSubmission' => 'Bạn có thể hoàn thành việc gửi bài này vào ngày sau đó bằng cách chọn Các bài gửi đang hoạt động từ trang tác giả.',
  ...
  'author.submit.copyrightNoticeAgree' => 'Các tác giả đồng ý với các điều khoản của Thông báo bản quyền này, sẽ áp dụng cho bài gửi này nếu và khi nó được xuất bản bởi tạp chí này (có thể thêm ý kiến cho biên tập viên bên dưới).',
  'author.submit.copyrightNoticeAgreeRequired' => 'Bạn phải đồng ý với các điều khoản của Thông báo bản quyền trước khi tiếp tục.',
  'submission.submit.coverNote' => 'Bình luận cho Biên tập viên',
  'author.submit.comments' => 'Nhập văn bản (tùy chọn)',
  'author.submit.form.sectionRequired' => 'Vui lòng chọn một chuyên mục thích hợp cho bài này.',
  'author.submit.form.localeRequired' => 'Vui lòng chọn một ngôn ngữ.',
  'submission.submit.privacyStatement' => 'Tuyên bố về quyền riêng tư của Tạp chí',
  ...
  'author.submit.suppFile.availableToPeers' => 'Tập tin dành cho người phản biện (không có siêu dữ liệu), vì nó sẽ dùng cho bình duyệt kín.',
